...
Current patch: **v2.2.3** — fixes the kick pipeline (long pre-kick hesitation, off-target kick direction), re-enables RL VisualKick with a 1.2–4.0m band-split hand-off to the scripted kick, and adds the GlanceAtGoal pre-shot aim check.
