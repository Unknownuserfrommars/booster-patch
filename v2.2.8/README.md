...
Current patch: **v2.2.8** — chase now runs at the robot's max forward speed (1.8 m/s) with faster turning to fix mid-chase stalling, less near-ball throttling, and a soft/short kick-off (`soft_kickoff` enabled). On top of v2.2.7 Rerun post-match logging, v2.2.6 tournament anti-interference compliance, and all v2.2.5 fixes.
