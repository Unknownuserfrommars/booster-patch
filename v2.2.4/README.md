...
Current patch: **v2.2.4** — deployment-script fixes (assist tree, install path + backup, systemd unit) and manual hand-eye calibration fixes (vision `model/` install now OPTIONAL, calibration intrin topic, `start_calibration.sh` diagnostics), on top of the v2.2.3 kick pipeline fixes.
