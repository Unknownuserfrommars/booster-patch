...
Current patch: **v2.2.2** — adds GameController fail-stop safety, hard stop on SET/END/penalty states, the v2.2.1 build macro fix, auto_calib.sh packaging, and the conservative 3v3 two-on-one wall-pass tactic.
